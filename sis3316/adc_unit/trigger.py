...
class Adc_trigger(object):
    ...
    _auto_properties = {
        "maw_peaking_time": Param(
            0xFFF,
            0,
            FIR_TRIGGER_SETUP_REG,
            """ Peaking time: number of values to sum. [2, 4, 6,... 510]""",
        ),
        "maw_gap_time": Param(
            0xFFF,
            12,
            FIR_TRIGGER_SETUP_REG,
            """ Gap time (flat time). [2, 4, 5,, ... 510]""",
        ),
        "out_pulse_length": Param(
            0xFE,
            24,
            FIR_TRIGGER_SETUP_REG,
        ...
        "high_threshold": Param(
            0xFFFFFFF,
            0,
            FIR_HIGH_ENERGY_THRESHOLD_REG,
